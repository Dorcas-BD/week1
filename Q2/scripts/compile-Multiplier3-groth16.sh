...
snarkjs r1cs Multiplier3.r1cs

snarkjs groth16 setup Multiplier3.r1cs powersOfTau28_hez_final_10.ptau Multiplier3/circuit_0000.zkey
snarkjs zkey contribute Multiplier3/circuit_0000.zkey Multiplier3/circuit_final.zkey --name="Dorcas" -v -e="I am a cryptographer"
